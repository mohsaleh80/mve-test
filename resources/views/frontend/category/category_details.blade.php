    ...
    $(document).ready(function(){
      ...
      //alert(sort_flag);
       if (sort_flag) {
            ...
            var id = {{ Js::from($category->id) }};
            var url = "{{ route('category.product.sort',[':sort_flag' ,':id']) }}";
    ...
    $(document).ready(function(){
      ...
      //alert(filter_flag);
       ...
       if (filter_flag) {
            ...
            var id = {{ Js::from($category->id) }};
            var url = "{{ route('category.product.filter',[':filter_flag' ,':id']) }}";
    ...
    $(document).ready(function(){
     ...
     // alert(qty_flag);
       ...
       if (show_flag) {
            ...
            var id = {{ Js::from($category->id) }};
            var url = "{{ route('category.product.show',[':show_flag' ,':id']) }}";
