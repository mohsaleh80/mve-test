            ...
            <div class="carausel-10-columns" id="carausel-10-columns">
                ...
                @endphp 
                    ...
                    @endphp
                            ...
                            <div class="card-2 bg-{{$i}} wow animate__animated animate__fadeInUp " data-wow-delay=".1s" style="width:400px">
                                <figure class="img-hover-scale overflow-hidden">
                                    <a href="{{route('category.details',[$category->id,$category->category_slug])}}" target="_blank"><img src="{{ asset($category->category_image) }}" alt="" /></a>
                                </figure>
                                <h6><a href="{{route('category.details',[$category->id,$category->category_slug])}}" target="_blank">{{$category->category_name}}</a></h6>
