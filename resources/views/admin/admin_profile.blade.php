                    ...
                    <div class="card">
                        <div class="card-body border border-2 rounded border-primary">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{(!empty($adminData->photo) ) ? asset($adminData->photo): url('uploads/no_image.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                        ...
                        <div class="card-body border  rounded ">
                          ...
                          <form method="post" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="facebook" class="form-control" value="{{$adminData->facebook}}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="twitter" class="form-control" value="{{$adminData->twitter}}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ (!empty($adminData->photo)) ? asset($adminData->photo):url('uploads/no_image.jpg') }}" alt="Admin" style="width:100px; height: 100px;"  >
                                    </div>
                                </div>
