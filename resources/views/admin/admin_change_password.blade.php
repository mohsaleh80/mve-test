								...
								<div class="card-body">
									<div class="p-5">
										<div class="sidebar-header">
                                            ...
                                            <div>
                                                <h4 class="logo-text">MVE - Admin</h4>
                                            </div>
										...
										<form method="post" action="{{ route('admin.update.password') }}"  >
											@csrf
												...
												<div class="d-grid gap-2">
													<button type="submit" class="btn btn-primary">Change Password</button> <a href="{{route('admin.logout')}}" class="btn btn-light"><i class='bx bx-arrow-back mr-1'></i>Back to Login</a>
												</div>
										</form>			
									</div>
								</div>
