...
<form id="myForm" method="post" action="{{ route('update.product',$products->id) }}" enctype="multipart/form-data" >
				...
				<div class="form-group col-md-6">
				  ...
				  <div class="col-12">
					...
					@foreach($activeVendor as $vendor)
						<option value="{{ $vendor->id }}"  @if($vendor->id== $products->vendor_id) echo selected @endif>{{ $vendor->name }}</option>
						 @endforeach
					  </select>
				  </div>
 ...
 <input class="form-check-input" name="hot_deals" type="checkbox" value="1" id="flexCheckDefault" @if($products->hot_deals == 1) echo checked @endif>
	...
	<div class="col-md-6">	
    <div class="form-check">
			<input class="form-check-input" name="featured" type="checkbox" value="1" id="flexCheckDefault" @if($products->featured == 1) echo checked @endif>
...
<div class="col-md-6">	
    <div class="form-check">
			<input class="form-check-input" name="special_offer" type="checkbox" value="1" id="flexCheckDefault" @if($products->special_offer == 1) echo checked @endif>
	...
	<div class="col-md-6">	
    <div class="form-check">
			<input class="form-check-input" name="special_deals" type="checkbox" value="1" id="flexCheckDefault" @if($products->special_deals == 1) echo checked @endif>
	...
	<table class="table mb-0 table-striped">
		...
		<tbody>
            @foreach($product_images as $key => $img)
				<form method="post" action="{{ route('update.product.multiimage',$img->id) }}" enctype="multipart/form-data" >
							@csrf
					...
					<tr>
						...
						<td> <input type="file" class="form-group" name="new_image"> </td>
						<td> 
					<input type="submit" class="btn btn-primary px-4" value="Update Image " />		
					<a href="{{ route('delete.product.multiimage',$img->id) }}" class="btn btn-danger" id="delete"> Delete </a>		
						</td>
					</tr>
