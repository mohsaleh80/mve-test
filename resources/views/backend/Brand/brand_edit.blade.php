...
<div class="col-lg-12">
	<div class="card">
		...
		<form id="myForm" method="Post" action="{{ route('brand.update',$brand->id) }}" enctype="multipart/form-data" >
			@csrf
            @method('PUT')
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="file" name="brand_image" class="form-control"  id="image" value=""  />
				</div>
			</div>
