...
<div class="col-lg-12">
	<div class="card">
		...
		<form method="post" action="{{ route('activate.vendor') }}" enctype="multipart/form-data" >
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" name="vendor_join" class="form-control" value="{{ $inactiveVendorDetails->created_at }}" />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ (!empty($inactiveVendorDetails->photo)) ? url($inactiveVendorDetails->photo):url('uploads/no_image.jpg') }}" alt="Vendor" style="width:100px; height: 100px;"  >
				</div>
			</div>
