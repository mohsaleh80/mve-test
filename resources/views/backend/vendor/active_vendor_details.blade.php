...
<div class="col-lg-12">
	<div class="card">
		...
		<form method="post" action="{{ route('deactivate.vendor') }}" enctype="multipart/form-data" >
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" class="form-control" value="{{ $activeVendorDetails->username }}" disabled />
				</div>
			</div>
			<div class="row mb-3">
				<div class="col-sm-3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" name="vendor_join" class="form-control" value="{{ $activeVendorDetails->created_at }}" />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ (!empty($activeVendorDetails->photo)) ? url($activeVendorDetails->photo):url('uploads/no_image.jpg') }}" alt="Vendor" style="width:100px; height: 100px;"  >
				</div>
			</div>
